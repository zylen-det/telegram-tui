...
type ViewModel struct {
	...
	Modal                  *app.ModalState
	ModalImage             image.Rectangle
	Prompt                 *app.PromptState
	...
	ForwardPicker          *app.ForwardPicker
	ReactionPicker         *app.ReactionPicker
	ReplyTarget            *app.ReplyTarget
	EditTarget             *app.EditTarget
	PhotoSend              *app.PhotoSendState
	StickerPicker          *app.StickerPickerState
	CommandMenu            *app.CommandMenuState
	...
	InviteLinks            *app.InviteLinksState
	Administration         *app.AdministrationState
	ChatSettings           *app.ChatSettingsState
...
func Select(state app.State, location *time.Location) ViewModel {
	if location == nil {
		location = time.Local
	}
	...
	topicKey := app.TopicKey{ChatID: model.ActiveChat.ID, TopicID: topicID}
	...
	if model.ActiveTopicKnown {
		...
		model.Draft = state.TopicDrafts[app.TopicKey{ChatID: model.ActiveChat.ID, TopicID: 0}]
		if state.EditTarget != nil && state.EditTarget.ChatID == model.ActiveChat.ID {
			model.Draft = state.EditTarget.Buffer
		}
	}
...
func cloneChatActions(menu *app.ChatActionMenuState) *app.ChatActionMenuState {
	if menu == nil {
		return nil
	}
	clone := *menu
...
func cloneModal(modal *app.ModalState) *app.ModalState {
	if modal == nil {
		return nil
	}
	clone := *modal
...
func clonePrompt(prompt *app.PromptState) *app.PromptState {
	if prompt == nil {
		return nil
	}
	clone := *prompt
...
func cloneMessageMenu(menu *app.MessageActionMenu) *app.MessageActionMenu {
	if menu == nil {
		return nil
	}
	clone := *menu
...
func cloneForwardPicker(picker *app.ForwardPicker) *app.ForwardPicker {
	if picker == nil {
		return nil
	}
	clone := *picker
...
func cloneReactionPicker(picker *app.ReactionPicker) *app.ReactionPicker {
	if picker == nil {
		return nil
	}
	clone := *picker
...
func cloneReplyTarget(target *app.ReplyTarget) *app.ReplyTarget {
	if target == nil {
		return nil
	}
	clone := *target
...
func cloneEditTarget(target *app.EditTarget) *app.EditTarget {
	if target == nil {
		return nil
	}
	clone := *target
...
func cloneStickerPicker(picker *app.StickerPickerState) *app.StickerPickerState {
	if picker == nil {
		return nil
	}
	clone := *picker
...
func cloneCommandMenu(menu *app.CommandMenuState) *app.CommandMenuState {
	if menu == nil {
		return nil
	}
	clone := *menu
...
func cloneMessageSearch(search *app.MessageSearchState) *app.MessageSearchState {
	if search == nil {
		return nil
	}
	clone := *search
...
func cloneChatSearch(search *app.ChatSearchState) *app.ChatSearchState {
	if search == nil {
		return nil
	}
	clone := *search
...
func selectMemberDetailAvatar(state app.State) pixel.Avatar {
...
func cloneMembers(members *app.MembersState) *app.MembersState {
	if members == nil {
		return nil
	}
	clone := *members
...
func cloneInviteLinks(links *app.InviteLinksState) *app.InviteLinksState {
	if links == nil {
		return nil
	}
	clone := *links
...
func cloneAdministration(admin *app.AdministrationState) *app.AdministrationState {
	if admin == nil {
		return nil
	}
	clone := *admin
...
func cloneChatSettings(settings *app.ChatSettingsState) *app.ChatSettingsState {
	if settings == nil {
		return nil
	}
	clone := *settings
...
func clonePinnedMessages(pinned *app.PinnedMessagesState) *app.PinnedMessagesState {
	if pinned == nil {
		return nil
	}
	clone := *pinned
...
func clonePhotoSend(ps *app.PhotoSendState) *app.PhotoSendState {
	if ps == nil {
		return nil
	}
	clone := *ps
...
func cloneTopics(topics *app.TopicListState) *app.TopicListState {
	if topics == nil {
		return nil
	}
	clone := *topics
