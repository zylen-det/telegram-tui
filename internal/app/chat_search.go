...
func openChatSearch(state State) (State, []Command) {
...
func reduceChatSearchAction(state State, event ActionReceived) (State, []Command) {
...
func activateChatSearchSelection(state State) (State, []Command) {
	search := state.ChatSearch
	if search == nil {
		return state, nil
	}
...
func reducePublicChatSearched(state State, event PublicChatSearched) (State, []Command) {
	search := state.ChatSearch
...
func reducePublicChatSearchFailed(state State, event PublicChatSearchFailed) (State, []Command) {
	search := state.ChatSearch
	if search == nil || search.RequestID != event.RequestID {
		return state, nil
	}
...
func reducePublicChatsSearched(state State, event PublicChatsSearched) (State, []Command) {
	search := state.ChatSearch
	if search == nil || search.RequestID != event.RequestID {
		return state, nil
	}
...
func reducePublicChatsSearchFailed(state State, event PublicChatsSearchFailed) (State, []Command) {
	search := state.ChatSearch
	if search == nil || search.RequestID != event.RequestID {
		return state, nil
	}
...
func reduceAllMessagesSearched(state State, event AllMessagesSearched) (State, []Command) {
	search := state.ChatSearch
	if search == nil || search.RequestID != event.RequestID {
		return state, nil
	}
...
func reduceAllMessagesSearchFailed(state State, event AllMessagesSearchFailed) (State, []Command) {
	search := state.ChatSearch
	if search == nil || search.RequestID != event.RequestID {
		return state, nil
	}
...
func openChatFromSearchResult(state State, chat domain.Chat) (State, []Command) {
...
func openChatFromMessageResult(state State, msg domain.Message) (State, []Command) {
	previousID, hadPrevious := activeChatID(state)
